...
python /home/zackary.hopkins/ra-code/run_fGAIN.py -d /data/projects/zackary.hopkins/genebycell.csv -m /data/projects/zackary.hopkins/masked_0.1.csv -l "Forward_KL"
